...
(ОГРНИП 317169000003180; адрес Республика Татарстан, г. Казань)
(далее &mdash; ИП) предлагает пользователю сети Интернет (далее
&mdash; Пользователь) использовать свои сервисы на условиях,
...
5.3. Период подписки и размер платы:
...
Пользователь может запросить возврат оплаты за последний Период в течении 30 дней с момента последнего платежа.
